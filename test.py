...
if __name__ == '__main__':
    ...
    #                     ]
    workspace1 = f'test/'
    workspace2 = f'hash_workspace_obj{obj_no}_{n}_{d}_{hashmap_size}/'
    # workspace3 = 'hash_workspace_obj12_7_8_10/'
    # workspace1 = f'Exp12/workspace/'
    # workspace2 = f'Exp11/'
    # _n = 1
    # idx_list = [360,180]
    # obj_list = [obj_path+f"{idx+1}.obj" for idx in range(_n) for obj_path in obj_path_pre_list]
    obj_list = ['data/obj_meshes/40.obj']
    _n = len(obj_list)
    print(f"total objs: {_n}")
    ...
    tcnn_network = torch.load(workspace2+'GT_mlp.pth')
    ...
    # print(models[0].backbone.params)
