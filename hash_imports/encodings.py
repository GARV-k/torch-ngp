...
class HashEncoding(Encoding):
    ...
    def pytorch_fwd(self, in_tensor: Float[Tensor, "*bs input_dim"],mode = 'normal',W = None, N=None,M=None,B1 = None,B2 = None,ret_new=False) -> Float[Tensor, "*bs output_dim"]:
        ...
        if not ret_new:
            ...
            return new_hash_table, torch.flatten(encoded_value, start_dim=-2, end_dim=-1)  # [..., num_levels * features_per_level]
    def forward(self, in_tensor: Float[Tensor, "*bs input_dim"],mode='normal',W=None,N=None,M = None,B1=None,B2=None,ret_new=False) -> Float[Tensor, "*bs output_dim"]:
        if self.tcnn_encoding is not None:
            return self.tcnn_encoding(in_tensor)
        return self.pytorch_fwd(in_tensor,mode,W,N,M,B1,B2,ret_new)
