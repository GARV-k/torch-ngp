...
# Example usage
folder_path = "inferences/GT2"  # Replace with your folder path
# for idx in [10,20,30,40,50,60]:
for idx in [90]:
    output_folder_path = f"datasets/W_dataset2"  # Replace with your output folder path
    rotate_vertices_y(folder_path, output_folder_path,idx)
# import os
